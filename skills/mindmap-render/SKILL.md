...
- Render a `topic_matrix.md` (a `research-explorer` deliverable) as a visual mindmap.
...
1. **Research** (mandatory): Use `web_search` to find authoritative, high-quality sources:
